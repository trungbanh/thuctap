...
class __TwigTemplate_cc13d633d96e1480a2b1985a1732a28039446fa186a6d2168d2d9b2dccba19ce extends \Twig\Template
{
    ...
    ";
        // line 32
        $context["user"] = twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["App"] ?? null), "session", [], "any", false, false, false, 32), "getUser", [], "method", false, false, false, 32);
        // line 33
        echo "    <div class='updatebox row'>
        <form id='detai' enctype='multipart/form-data'>
            <input name=\"idAuthor\" type=\"hidden\" value= ";
        // line 35
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "getIdAuthor", [], "method", false, false, false, 35), "html", null, true);
        echo " > <br/>
            Tên: <input name=\"nickname\" type=\"text\" value= ";
        // line 36
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "getNickname", [], "method", false, false, false, 36), "html", null, true);
        echo " > <br/>
            Email: <input name=\"mail\" type=\"text\" value= ";
        // line 37
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "getMail", [], "method", false, false, false, 37), "html", null, true);
        echo "> <br/>
...
";
    ...
    {
        return array (  94 => 37,  90 => 36,  86 => 35,  82 => 33,  80 => 32,  50 => 4,  46 => 3,  35 => 1,);
    }
